...
def getAutoThresh(scores):
	newRedThresh = prevRedThresh + (prevRedThresh - getThreshold(redPercent, scores))/2
	newAmberThresh = prevAmberThresh + (prevAmberThresh - getThreshold(amberPercent, scores))/2
